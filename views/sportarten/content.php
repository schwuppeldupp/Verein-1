			...
			<tbody>
				<?php
                    foreach ($data as $sportart) {
                        echo '<form id="sportart" role="form" action="' . DIR . 'sportarten/sportarten/1" method="POST">' . "\n";
                    ...
                    echo '<form id="sportart" role="form" action="' . DIR . 'sportarten/sportarten/0" method="POST">' . "\n";
